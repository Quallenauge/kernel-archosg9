...
{
	printk(KERN_ERR "Perform archos reserve...\n");
	omap_init_ram_size();

#ifdef CONFIG_ION_OMAP
	printk(KERN_ERR "Perform omap_ion_init()\n");

	get_omap_ion_platform_data()->tiler2d_size = (SZ_128M - SZ_32M);
	get_omap_ion_platform_data()->nonsecure_tiler2d_size = SZ_32M;
	...
	sgx_omaplfb_set(0, omaplfb_config_wuxga);
#endif
